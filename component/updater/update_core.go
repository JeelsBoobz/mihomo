...
func init() {
	...
	if !strings.HasPrefix(C.Version, "alpha") {
		baseURL = "https://github.com/JeelsBoobz/mihomo/releases/latest/download/mihomo"
		versionURL = "https://github.com/JeelsBoobz/mihomo/releases/latest/download/version.txt"
	}
}
